import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as c,o,c as l,e as t,a as n,d as a,f as p}from"./app-1ca022be.js";const i="/img/head/kanbanniang.png",u="/img/head/baitian.png",r="/img/head/heiye.png",k="/img/head/shubiao.png",d={},v=p(`<div style="text-align:center;"><p><strong>代码中每一行的代码都有注释说明，请仔细查看并使用</strong></p></div><h2 id="自定义头部代码" tabindex="-1"><a class="header-anchor" href="#自定义头部代码" aria-hidden="true">#</a> 自定义头部代码</h2><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--Alist V3建议添加的，已经默认添加了，如果你的没有建议加上--&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果提供的这些也失效了可以考虑自建十分的简单</p>`,7),m={href:"https://github.com/anwen-anyi/Meting2-API#%E5%8D%8E%E4%B8%BA%E4%BA%91",target:"_blank",rel:"noopener noreferrer"},b=n("strong",null,"https://github.com/anwen-anyi/Meting2-API#华为云",-1),g={href:"https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fxizeyoupan%2FMeting-API",target:"_blank",rel:"noopener noreferrer"},h=n("strong",null,"一键部署到Vercel",-1),f={href:"https://github.com/xizeyoupan/Meting-API#cloudflare-workers",target:"_blank",rel:"noopener noreferrer"},y=n("strong",null,"Cloudflare Workers",-1),x=p('<p>如果你要部署到华为云可以看我写的我改了一些比较详细</p><h4 id="部署到国内和国外有什么区别吗" tabindex="-1"><a class="header-anchor" href="#部署到国内和国外有什么区别吗" aria-hidden="true">#</a> 部署到国内和国外有什么区别吗</h4><ul><li>如果部署在国外咱们解析QQ音乐的时候就无法播放了</li><li>网易不论部署在国内还是国外都可以解析播放</li></ul><h2 id="看板娘代码" tabindex="-1"><a class="header-anchor" href="#看板娘代码" aria-hidden="true">#</a> 看板娘代码</h2><div class="hint-container tip"><p class="hint-container-title">提示</p><p>看板娘上游提供的大佬暂时不提供了，如果那天恢复了这里会修改说明</p><p>（挺费流量的QAQ 😂 😂）</p><figure><img src="'+i+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure></div><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--看板娘 -自定义大小，隐藏对话框和对话框高度--&gt;</span>
...
<span class="token punctuation">}</span>
&lt;/style&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="效果预览" tabindex="-1"><a class="header-anchor" href="#效果预览" aria-hidden="true">#</a> 效果预览</h4><div style="text-align:center;"><p>左侧为不带毛玻璃效果，右侧为带毛玻璃效果.推荐右侧带毛玻璃效果的</p></div><figure><img src="`+u+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><figure><img src="'+r+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><br><h2 id="自行替换鼠标样式说明" tabindex="-1"><a class="header-anchor" href="#自行替换鼠标样式说明" aria-hidden="true">#</a> 自行替换鼠标样式说明</h2><p><s><strong>因为CDN的 HTTPS证书失效了，无法使用暂时</strong></s></p><p><s><strong>但是着急的话可以一个一个点击然后把哪个文件下载下来，然后自己上传一个换成自己的链接也可以..</strong></s></p><div class="hint-container danger"><p class="hint-container-title">警告</p><p>提供的链接已经失效，有需要的可以自己找一些相关的鼠标手动去替换，按照下面的格式即可</p></div><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--较为个性化的鼠标指针样式，可结合个人需要自行修改--&gt;</span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>style</span><span class="token punctuation">&gt;</span></span><span class="token style"><span class="token language-css">
  <span class="token selector">body</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+k+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure>',23);function _(q,w){const s=c("ExternalLinkIcon");return o(),l("div",null,[t(" 你可以通过设置页面的 Frontmatter，在页面禁用功能与布局。 "),t(" more "),v,n("ul",null,[n("li",null,[n("p",null,[n("a",m,[b,a(s)])])]),n("li",null,[n("p",null,[n("a",g,[h,a(s)])])]),n("li",null,[n("p",null,[n("a",f,[y,a(s)])])])]),x])}const V=e(d,[["render",_],["__file","05-head.html.vue"]]);export{V as default};
