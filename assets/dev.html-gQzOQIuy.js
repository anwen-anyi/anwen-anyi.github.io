import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as l,c as t,a as n,b as e,d as a,e as i}from"./app-7_NCf5aD.js";const r="/img/sso/dev/cmd.png",c={},u=n("h2",{id:"开发须知",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#开发须知"},[n("span",null,[n("strong",null,"开发须知")])])],-1),v=n("p",null,[e("开发Cadoor需要使用 "),n("code",null,"Go > 1.17+"),e("，"),n("code",null,"Node.js ≥ 14&16"),e("，"),n("code",null,"Yarn 1.x"),e(" 版本")],-1),p={href:"https://classic.yarnpkg.com/en/docs/install",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/casdoor/casdoor/issues/294",target:"_blank",rel:"noopener noreferrer"},b={href:"https://git-scm.com/download/win",target:"_blank",rel:"noopener noreferrer"},h=i(`<div class="language-git line-numbers-mode" data-ext="git" data-title="git"><pre class="language-git"><code>git clone https://github.com/casdoor/casdoor
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到这里基本上结束了，可以去愉快的给<code>应用</code>接入登录了</p><br><p>那里不清楚大家可以留言 会回复的。</p>`,5);function S(B,N){const s=d("ExternalLinkIcon");return l(),t("div",null,[u,v,n("p",null,[e("官网推荐使用 "),n("a",p,[e("Yarn 1.x"),a(s)]),e(" 运行 & Casdoor 前端，使用 NPM可能会导致UI 风格问题。 更多详细信息见： "),n("a",m,[e("Casdoor#294"),a(s)])]),n("p",null,[e("然后我们将开源代码下载下来，或者使用 "),n("a",b,[e("Git Bash"),a(s)]),e(" clone到本地")]),h,n("p",null,[e("配置文件所有参数的作用我这里细说了,下面我只说一下如何配置数据库和"),g,e("是做什么的吧"),n("a",f,[e("详情查看Casdoor官网"),a(s)])]),_,n("p",null,[e("还有更多的数据库用法，有需要的可以前往"),n("a",k,[e("Casdoor官网"),a(s)]),e("看看")]),x,n("p",null,[e("输入"),q,e("启动后等待一会儿，就会自动打开一个浏览器 "),n("a",y,[e("http://localhost:7001/"),a(s)])]),E])}const L=o(c,[["render",S],["__file","dev.html.vue"]]);export{L as default};
