import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as r,c as t,a as o,b as n,d as e,e as i,f as a}from"./app-a7167b09.js";const c="/img/sso/dev/cmd.png",u={},v=n("h2",{id:"开发须知",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#开发须知","aria-hidden":"true"},"#"),e(),n("strong",null,"开发须知")],-1),p=n("p",null,[e("开发Cadoor需要使用 "),n("code",null,"Go > 1.17+"),e("，"),n("code",null,"Node.js ≥ 14&16"),e("，"),n("code",null,"Yarn 1.x"),e(" 版本")],-1),m={href:"https://classic.yarnpkg.com/en/docs/install",target:"_blank",rel:"noopener noreferrer"},b={href:"https://github.com/casdoor/casdoor/issues/294",target:"_blank",rel:"noopener noreferrer"},h={href:"https://git-scm.com/download/win",target:"_blank",rel:"noopener noreferrer"},g=a(`<div class="language-git line-numbers-mode" data-ext="git"><pre class="language-git"><code>git clone https://github.com/casdoor/casdoor
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>到这里基本上结束了，可以去愉快的给<code>应用</code>接入登录了</p><br><p>那里不清楚大家可以留言 会回复的。</p>`,5);function S(B,C){const s=l("ExternalLinkIcon");return r(),t("div",null,[o(" 你可以通过设置页面的 Frontmatter，在页面禁用功能与布局。 "),o(" more "),v,p,n("p",null,[e("官网推荐使用 "),n("a",m,[e("Yarn 1.x"),i(s)]),e(" 运行 & Casdoor 前端，使用 NPM可能会导致UI 风格问题。 更多详细信息见： "),n("a",b,[e("Casdoor#294"),i(s)])]),n("p",null,[e("然后我们将开源代码下载下来，或者使用 "),n("a",h,[e("Git Bash"),i(s)]),e(" clone到本地")]),g,n("p",null,[e("配置文件所有参数的作用我这里细说了,下面我只说一下如何配置数据库和"),f,e("是做什么的吧"),n("a",_,[e("详情查看Casdoor官网"),i(s)])]),k,n("p",null,[e("还有更多的数据库用法，有需要的可以前往"),n("a",x,[e("Casdoor官网"),i(s)]),e("看看")]),q,n("p",null,[e("输入"),y,e("启动后等待一会儿，就会自动打开一个浏览器 "),n("a",E,[e("http://localhost:7001/"),i(s)])]),N])}const A=d(u,[["render",S],["__file","dev.html.vue"]]);export{A as default};
