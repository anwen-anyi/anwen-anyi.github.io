import{_ as e,Y as c,Z as o,a2 as t,$ as n,a0 as a,a4 as p,F as l}from"./framework-ea4de93e.js";const i="/img/head/baitian.png",u="/img/head/heiye.png",r="/img/head/shubiao.png",k={},d=p(`<div style="text-align:center;"><p><strong>代码中每一行的代码都有注释说明，请仔细查看并使用</strong></p></div><h2 id="自定义头部代码" tabindex="-1"><a class="header-anchor" href="#自定义头部代码" aria-hidden="true">#</a> 自定义头部代码</h2><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--Alist V3建议添加的，已经默认添加了，如果你的没有建议加上--&gt;</span>
