import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as c,o,c as l,a as t,b as n,e as a,f as p}from"./app-d81309de.js";const i="/img/head/kanbanniang.png",u="/img/head/baitian.png",r="/img/head/heiye.png",k="/img/head/shubiao.png",d={},v=p(`<div style="text-align:center;"><p><strong>代码中每一行的代码都有注释说明，请仔细查看并使用</strong></p></div><h2 id="自定义头部代码" tabindex="-1"><a class="header-anchor" href="#自定义头部代码" aria-hidden="true">#</a> 自定义头部代码</h2><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token comment">&lt;!--Alist V3建议添加的，已经默认添加了，如果你的没有建议加上--&gt;</span>
