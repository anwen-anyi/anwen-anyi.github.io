import{_ as u}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as v,c as h,a as t,b as e,d as n,e as s,w as o,f as a}from"./app-e2fad9af.js";const m={},b=e("p",null,[e("strong",null,"Cadoor是什么?")],-1),g={href:"https://casdoor.org/zh/docs/overview",target:"_blank",rel:"noopener noreferrer"},p=a('<p>不多废话了我们直接开始编译</p><br><h2 id="编译cadoor前准备工作" tabindex="-1"><a class="header-anchor" href="#编译cadoor前准备工作" aria-hidden="true">#</a> <strong>编译Cadoor前准备工作</strong></h2><p>开发Cadoor需要使用 <code>Go &gt; 1.17+</code>，<code>Node.js ≥ 14&amp;16</code>，<code>Yarn 1.x</code> 版本</p>',4),_={href:"https://classic.yarnpkg.com/en/docs/install",target:"_blank",rel:"noopener noreferrer"},f={href:"https://github.com/casdoor/casdoor/issues/294",target:"_blank",rel:"noopener noreferrer"},x={href:"https://git-scm.com/download/win",target:"_blank",rel:"noopener noreferrer"},k=e("div",{class:"language-git line-numbers-mode","data-ext":"git"},[e("pre",{class:"language-git"},[e("code",null,`git clone https://github.com/casdoor/casdoor
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),L=e("code",null,"8000端口",-1),z={href:"https://casdoor.org/zh/docs/basic/server-installation#%E9%80%9A%E8%BF%87-ini-%E6%96%87%E4%BB%B6%E9%85%8D%E7%BD%AE",target:"_blank",rel:"noopener noreferrer"},V=a(`<p>casdoor默认使用的是<strong>MySQL</strong>数据库，如果你也是使用<strong>MySQL</strong>可以按照以下格式填写,应该看得懂什么意思 实在不懂可以评论区问问</p><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>	......
driverName = mysql
dataSourceName = root:123123@tcp(localhost:3306)/
dbName = casdoor
	......
...
httpport = 8000
runmode = dev
</code></pre><div class="highlight-lines"><br><div class="highlight-line"> </div><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>8000端口</code>是后端应用程序正在监听的端口，也是你要接入的时候需要填写的</p><p>例如我们接入<code>AList</code>在单点登录选项,<code>SSO端点名称</code>就是我们要写的 http(s)://192.168.31.1:8000，写进AList单点登录配置的选项里面</p><ul><li>注:如果8000端口号和你的冲突你可以随便改</li><li>如果你嫌弃有端口号不方便，你可以将<code>8000</code>端口号进行反向代理，像AList那样反向代理把端口号去掉</li></ul><br><p>那里不清楚大家可以留言 会回复的。</p>`,7);function F(G,I){const i=r("ExternalLinkIcon"),c=r("Tabs");return v(),h("div",null,[t(" 你可以通过设置页面的 Frontmatter，在页面禁用功能与布局。 "),t(" more "),b,e("p",null,[n("Cadoor是什么我这里就不说了，有需要的应该知道是什么，不知道的可以看看"),e("a",g,[n("Cadoor官网"),s(i)])]),p,e("p",null,[n("官网推荐使用 "),e("a",_,[n("Yarn 1.x"),s(i)]),n(" 运行 & Casdoor 前端，使用 NPM可能会导致UI 风格问题。 更多详细信息见： "),e("a",f,[n("Casdoor#294"),s(i)])]),e("p",null,[n("然后我们将开源代码下载下来，或者使用 "),e("a",x,[n("Git Bash"),s(i)]),n(" clone到本地")]),k,q,C,e("p",null,[n("我们根据"),E,n("的"),e("a",N,[n("文档"),s(i)]),n("来使用")]),S,A,s(c,{id:"38",data:[{id:"Windows"},{id:"Linux"}],"tab-id":"build"},{title0:o(({value:d,isActive:l})=>[n("Windows")]),title1:o(({value:d,isActive:l})=>[n("Linux")]),tab0:o(({value:d,isActive:l})=>[B]),tab1:o(({value:d,isActive:l})=>[y]),_:1}),w,e("p",null,[n("配置文件所有参数的作用我这里细说了,下面我只说一下如何配置数据库和"),L,n("是做什么的吧"),e("a",z,[n("详情查看Casdoor官网"),s(i)])]),V,e("p",null,[n("还有更多的数据库用法，有需要的可以前往"),e("a",P,[n("Casdoor官网"),s(i)]),n("看看")]),D])}const j=u(m,[["render",F],["__file","build.html.vue"]]);export{j as default};
