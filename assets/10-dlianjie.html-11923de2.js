...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>缩短后我们打开短连接会跳到开始的那个这样很方便</p><p>下面我们就开始说一下怎么搭建吧</p><br><h2 id="_2-开始" tabindex="-1"><a class="header-anchor" href="#_2-开始" aria-hidden="true">#</a> <strong>2.开始</strong></h2><h3 id="_2-1-准备" tabindex="-1"><a class="header-anchor" href="#_2-1-准备" aria-hidden="true">#</a> <strong>2.1 准备</strong></h3>`,13),E={href:"https://github.com/YOURLS/YOURLS",target:"_blank",rel:"noopener noreferrer"},w={href:"https://github.com/taozhiyu/yourls-translation-zh_CN",target:"_blank",rel:"noopener noreferrer"},B={href:"https://www.52pojie.cn/home.php?mod=space&uid=879080&do=profile&from=space",target:"_blank",rel:"noopener noreferrer"},R=n("strong",null,"@52破解涛之雨",-1),L={href:"https://www.crxsoso.com/webstore/detail/nddaaiojgkoldnhnmkoldmkeocbooken",target:"_blank",rel:"noopener noreferrer"},y={href:"https://www.aliyundrive.com/s/wCNVf6YgCL8",target:"_blank",rel:"noopener noreferrer"},S=n("li",null,[n("strong",null,"自用汉化"),s("：上述的本地备用里面有一个是我自己将插件解压汉化了的，但是 "),n("code",null,"Chrome"),s("浏览器用不了 360浏览器可以自己选择吧")],-1),x=i('<p>这个短连接也支持查看点击次数喔~</p><br><h3 id="_2-2-初始化" tabindex="-1"><a class="header-anchor" href="#_2-2-初始化" aria-hidden="true">#</a> <strong>2.2 初始化</strong></h3><p>短连接程序和汉化包已经准备好了，接下来我们就开始配置一下 <strong>YOURLS<sup>短连接程序</sup></strong> 和汉化包吧</p><h4 id="配置汉化包" tabindex="-1"><a class="header-anchor" href="#配置汉化包" aria-hidden="true">#</a> <strong>配置汉化包</strong></h4>',5),U=i('<figure><img src="'+p+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><br><h4 id="配置短连接程序配置文件" tabindex="-1"><a class="header-anchor" href="#配置短连接程序配置文件" aria-hidden="true">#</a> <strong>配置短连接程序配置文件</strong></h4><p>原生的配置文件里面是英文的现在进行了汉化</p><p>配置文件原来是叫 <strong><code>config-sample.php</code></strong>，我们<mark>需要手动</mark>修改为 <strong><code>config.php</code></strong></p><ul><li>自己修改前：<code>/user/config-sample.php</code></li><li>自己修改后：<code>/user/config.php</code></li></ul><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
&lt;/IfModule&gt;
# END YOURLS
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><h3 id="_3-2-如何配置插件来分享alist" tabindex="-1"><a class="header-anchor" href="#_3-2-如何配置插件来分享alist" aria-hidden="true">#</a> <strong>3.2 如何配置插件来分享AList</strong></h3><p>插件我们下载下来，后添加到浏览器扩展，怎么添加可以查看下方的视频</p>`,22),A=n("code",null,"360，Chrome，Edge",-1),q={href:"https://youtu.be/PP6b0WSzYMc",target:"_blank",rel:"noopener noreferrer"},O={href:"https://www.crxsoso.com/webstore/detail/nddaaiojgkoldnhnmkoldmkeocbooken",target:"_blank",rel:"noopener noreferrer"},Y={href:"https://www.aliyundrive.com/s/wCNVf6YgCL8",target:"_blank",rel:"noopener noreferrer"},N=n("li",null,[n("p",null,[n("strong",null,"自用汉化"),s("：上述的本地备用里面有一个是我自己将插件解压汉化了的，但是 "),n("code",null,"Chrome"),s("浏览器用不了 360浏览器可以自己选择吧")])],-1),C=n("p",null,[s("将插件添加到浏览器后，点击插件的 "),n("code",null,"设置|setting"),s("选项进行配置，")],-1),F=n("p",null,[s("第二个选项里面的签名是在 "),n("code",null,"http(s)://你的链接/admin/tools.php"),s(" 页面里面的"),n("code",null,"安全的API调用"),s(" 标题的往下数第三行里面有个参数复制一下填写")],-1),I=n("p",null,"大家看下面的图吧，一个是我自己汉化了的，一个是原生英文的",-1),M=n("div",{class:"image-preview"},[n("img",{src:m}),n("img",{src:g})],-1),D=i('<figure><img src="'+h+'" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="_3-3-使用这个短连接的一些说明" tabindex="-1"><a class="header-anchor" href="#_3-3-使用这个短连接的一些说明" aria-hidden="true">#</a> <strong>3.3 使用这个短连接的一些说明</strong></h3><ol><li>不推荐将所有人都可以生成短链接选项打开，防止别人使用你的短连接分发一些&quot;奇奇怪怪&quot;的东西去喝茶</li><li>建议打开 <strong><code>是否自动将结果复制到剪贴板? | Auto-copy result to clipboard?</code></strong> 这样我们点击插件后就不要手动去点copy了它会自动帮你复制你只需要去粘贴分享即可</li><li>其实在链接右键会弹出的选项中也可以选择 <strong>YOURLS<sup>短连接程序</sup></strong> 插件,然后点击顶部的插件扩展栏就会进行缩短链接</li></ol><div class="image-preview"><img src="'+b+'"><img src="'+k+'"></div>',4),z=i(`<ol start="5"><li>防止被爆破，修改 <code>/admin</code>文件夹为你想改的名字，然后在<code>/user</code>目录新建<code>cache.php</code>内容如下：</li></ol><div class="language-php line-numbers-mode" data-ext="php"><pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span>
...
</span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),Q={href:"https://github.com/YOURLS/YOURLS/pull/2747#issuecomment-689047797",target:"_blank",rel:"noopener noreferrer"},T=n("ol",{start:"6"},[n("li",null,[s("其他的暂时没有了，"),n("mark",null,"第五条挺重要的改一下吧也不麻烦")])],-1),$=n("br",null,null,-1),P=n("h2",{id:"_4-结语-结束",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_4-结语-结束","aria-hidden":"true"},"#"),s(),n("strong",null,"4. 结语-结束")],-1),V=n("p",null,"到这里就结束了，有兴趣的话大家去试试看吧，可能文字描述的不是很详细，视频版嘛 在路上了敬请期待吧，视频发了这里会进行修改",-1);function j(W,G){const a=t("ExternalLinkIcon"),o=t("Badge");return c(),d("div",null,[l(" 你可以通过设置页面的 Frontmatter，在页面禁用功能与布局。 "),l(" more "),f,n("ol",null,[n("li",null,[n("p",null,[s("短连接程序："),n("a",E,[s("https://github.com/YOURLS/YOURLS"),e(a)])])]),n("li",null,[n("p",null,[s("短连接汉化："),n("a",w,[s("https://github.com/taozhiyu/yourls-translation-zh_CN"),e(a)])]),n("ul",null,[n("li",null,[s("汉化是由 "),n("a",B,[R,e(a)]),s(" 提供")])])]),n("li",null,[n("p",null,[s("Web扩展插件："),n("a",L,[s("https://www.crxsoso.com/webstore/detail/nddaaiojgkoldnhnmkoldmkeocbooken"),e(a)])]),n("ul",null,[n("li",null,[s("本地备用："),n("a",y,[s("https://www.aliyundrive.com/s/wCNVf6YgCL8"),e(a)])]),S])])]),x,n("p",null,[s("我们只需要把汉化包里面的两个文件(*.mo *.po)移动到 已经下载好的YOURLS程序包里面的"),e(o,{text:"/user/languages",type:"danger",vertical:"middle"}),s(" 文件夹就行")]),U,n("p",null,[s("涵盖 "),A,s("三款浏览器："),n("a",q,[s("https://youtu.be/PP6b0WSzYMc"),e(a)]),s(" 只看怎么添加扩展插件即可")]),n("blockquote",null,[n("ul",null,[n("li",null,[n("p",null,[s("Web扩展插件："),n("a",O,[s("https://www.crxsoso.com/webstore/detail/nddaaiojgkoldnhnmkoldmkeocbookenopen in new window"),e(a)])]),n("ul",null,[n("li",null,[n("p",null,[s("本地备用："),n("a",Y,[s("https://www.aliyundrive.com/s/wCNVf6YgCL8open in new window"),e(a)])])]),N])])])]),C,F,I,M,s(" 这个配置好后，我们去试试看效果，下面的是我的一个Demo "),D,s(" 4. 记得在配置文件里面设置的帐号密码困难一些，防止别人登录 "),z,n("p",null,[s("可能会被爆破的围观链接："),n("a",Q,[s("https://github.com/YOURLS/YOURLS/pull/2747#issuecomment-689047797"),e(a)])]),T,$,P,V])}const H=r(_,[["render",j],["__file","10-dlianjie.html.vue"]]);export{H as default};
